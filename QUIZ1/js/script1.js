const STORE = {
 questions: {
  accessibility: [
   {
    question: "The word additive means:",
    code: ``,
    answers: [
     "A statement added to the end of a message",
     "A substance added to another to alter or improve it in some way, such as to change the color or texture of food",
     "A number that is added to another number to make a total. In 2 + 3 = 5, the 2 and the 3 are additives",
     "An ingredient in a recipe"
    ],
    correctAnswer: "A substance added to another to alter or improve it in some way, such as to change the color or texture of food"
   },
//    {
...
//    }
  ...
  arrays: [
   {
    question: "The word AIDS means:",
    code: ``,
    answers: [
     "A disease you get from drinking milk produced by cows that have been given drugs",
     "An energy saving transit (railway) system which aids a person in getting from one city to another without using fossil fuels (gasoline)",
     "A type of fungus that infects the intestines",
     "A disease that destroys the natural system of protection that the body uses against other diseases (short for Acquired Immune Deficiency Syndrome)"
    ],
    correctAnswer: "A disease that destroys the natural system of protection that the body uses against other diseases (short for Acquired Immune Deficiency Syndrome)"
   }
//    ,{
...
//    }
  ...
  elements: [
    {
            question: "The word collapsed veins means:",
            code: ` `,
            answers: [
             "Damage caused by repeated injections into veins (in the arms or other areas of the body) using needles",
             "A heart condition in which the veins to the heart get too thin and don’t allow enough blood to return to the heart",
             "When the veins in the arms and legs are enlarged and protrude (stick out) and can be seen on the surface of the skin",
             "When the blood vessels to and from the brain no longer pass blood through them and the person blacks out"
            ],
            correctAnswer: "Damage caused by repeated injections into veins (in the arms or other areas of the body) using needles"
           }
   
  ],
  flexbox: [
    {
        question: "The word cut means:",
        code: ``,
        answers: [
         "To be absent from a place without authorization",
         "To add a substance to another, especially to a drug or an alcoholic drink, usually to make it weaker or cheaper",
         "To divide a drug dosage into smaller portions",
         "To trim or shorten the length of something being smoked"
        ],
        correctAnswer: "To add a substance to another, especially to a drug or an alcoholic drink, usually to make it weaker or cheaper"
       }
  ],
  forms: [
    {
        question: "The word tuberculosis means:",
        code: ``,
        answers: [
         "A disease of the foot, consisting of growths that look like small tubers (roots)",
         "An addiction to riding inner tubes down rivers",
         "An infectious disease of the mouth, often accompanied with foul breath and rotting teeth",
         "An infectious disease affecting the lungs and other organs"
        ],
        correctAnswer: "An infectious disease affecting the lungs and other organs"
       }
  ], 
  }
 };
