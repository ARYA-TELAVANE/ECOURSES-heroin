const STORE = {
 questions: {
  accessibility: [
   {
    question: "Heroin is made from poppy plants",
    code: ` `,
    answers: [
     "True",
     "False",
  ...
  arrays: [
   {
    ...
    correctAnswer: "Injected, snorted or smoked"
   }],

  elements: [
    {
        question: "Aside from the dangers of the drug itself, what other risks are there from heroin use?",
        code: ` `,
        answers: [
        ...
        correctAnswer: "Both contracting AIDS, hepatitis (liver disease) and other diseases from infected needles, as well as spreading contracted disease to sexual partners or to newborns"
      }

  ],
  flexbox: [
    {
        question: "What are some of the short-term effects of heroin?",
        code: ``,
        answers: [
        ...
        correctAnswer: "Clouded mental functioning, nausea and vomiting"
       }

  ],
  forms: [
    {
        question: "What are some of the long-term effects of heroin?",
        code: ``,
        answers: [
         "Increased energy",
        ...
        correctAnswer: "Collapsed veins and soft tissue infections"
       }
